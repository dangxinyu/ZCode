...
function buildInitAgentsPrompt(params: {
  ...
  return [
    "You are running Don’t-think's built-in /init command.",
    "",
    "Your task is to create or update a concise workspace instruction file for future Don’t-think agents.",
    "",
    "Target:",
    ...
    "6. Include only project-specific facts future Don’t-think agents would otherwise miss.",
