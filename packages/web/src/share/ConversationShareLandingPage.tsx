...
const COPY: Record<ConversationShareLandingLocale, Copy> = {
  "zh-CN": {
    ...
    outdatedTitle: "需要更新 Don’t-think",
    outdatedDescription: "这个分享由更新版本的 Don’t-think 创建，请升级后再查看。",
    unavailableTitle: "分享不可访问",
    unavailableDescription: "当前账号没有权限，或者分享内容已不存在。",
    retry: "重试",
    continueInZCode: "去 Don’t-think 继续",
    switchToDarkTheme: "切换到深色主题",
    switchToLightTheme: "切换到浅色主题",
    continueHelp: "如果没有自动打开 Don’t-think，请先下载客户端，或再次尝试打开。",
    downloadZCode: "下载 Don’t-think",
    artifactCountOne: "{count} 个结果物",
    artifactCountOther: "{count} 个结果物",
    retryOpen: "再次打开",
  },
  "en-US": {
    brand: "Don’t-think Conversation Share",
    ...
    outdatedTitle: "Update Don’t-think to continue",
    outdatedDescription:
      "This share was created by a newer version of Don’t-think. Please update to view it.",
    unavailableTitle: "Share unavailable",
    unavailableDescription:
      "This account is not allowed to view the share, or it no longer exists.",
    retry: "Try again",
    continueInZCode: "Continue in Don’t-think",
    switchToDarkTheme: "Switch to dark theme",
    switchToLightTheme: "Switch to light theme",
    continueHelp: "If Don’t-think did not open, download the app or try opening it again.",
    downloadZCode: "Download Don’t-think",
