...
const WORKFLOW_NAME = "Open in Don’t-think.workflow";
const WORKFLOW_BUNDLE_ID = "dev.dontthink.app.finder-open-workflow";
const WORKFLOW_VERSION = "5";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在Don’t-think中打开",
  "en-US": "Open in Don’t-think",
};
