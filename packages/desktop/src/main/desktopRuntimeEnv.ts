...
// e2e 运行的是生产构建，默认会和本机正式版 Don’t-think 共用 app name / userData，
...
export const runtimeApplicationName =
  ...
  (isLocalDevelopmentRuntime ? "Don’t-think Dev" : isPreviewPackagedRuntime ? "Don’t-think Preview" : "Don’t-think");
