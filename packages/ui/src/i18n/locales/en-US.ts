...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Don’t-think to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let Don’t-think remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Don’t-think",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Don’t-think.",
  ...
  "startup.global.starting_services": "Starting Don’t-think",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Don’t-think will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Don’t-think or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Don’t-think. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Don’t-think to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Don’t-think.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Don’t-think restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Don’t-think",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Don’t-think and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to Don’t-think",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to Don’t-think",
  "login.description": "Connect your account to start using Don’t-think",
  ...
  "logout.confirm.title": "Disconnect and restart Don’t-think?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Don’t-think Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Don’t-think",
  ...
  "forceUpdate.title": "Update Don’t-think to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Don’t-think to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Don’t-think CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Don’t-think checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Don’t-think terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While Don’t-think is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Don’t-think installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Don’t-think task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Don’t-think",
  ...
  "resourceManager.storage.diskUsage": "Don’t-think uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Don’t-think desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Don’t-think could not verify its Windows secure import component. Reinstall or update Don’t-think before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Don’t-think will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Don’t-think Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Don’t-think provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Don’t-think Agent cannot refresh OAuth status. Upgrade or restart Don’t-think, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Don’t-think to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Don’t-think",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Don’t-think 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Don’t-think automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Don’t-think.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Don’t-think uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Don’t-think after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Don’t-think MCP",
  ...
  "sidebar.usage.plan.mcp": "Don’t-think MCP",
  "sidebar.usage.plan.zcodeMcp": "Don’t-think MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for Don’t-think built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Don’t-think. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Don’t-think follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Don’t-think",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Don’t-think Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Don’t-think with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Don’t-think and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Don’t-think follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Don’t-think",
  ...
  "settings.commands.description":
    "Manage Don’t-think Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "Don’t-think Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Don’t-think. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Don’t-think follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Don’t-think",
  ...
  "settingsSync.action.finish": "Start using Don’t-think",
  "settingsSync.agent.zcode": "Don’t-think Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Don’t-think settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Don’t-think",
  ...
  "onboarding.welcome.title": "Welcome to Don’t-think",
  "onboarding.welcome.start": "Start Don’t-think",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Don’t-think imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Don’t-think will copy {source} to {target}.\nIf the target file already exists, the Don’t-think default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Don’t-think anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Don’t-think anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Don’t-think will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Don’t-think to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Don’t-think app and retry, or ask Don’t-think to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Don’t-think in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Don’t-think: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Don’t-think in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Don’t-think Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    `Don’t-think MCP "{server}" has used up today's quota. It resets tomorrow.`,
  "chat.quota.mcp.codingPlanRequired":
    `No Don’t-think MCP "{server}" quota. Sign in or get a Coding Plan to use it.`,
  ...
  "resourceManager.appUsage": "Don’t-think",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Don’t-think Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Don’t-think is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Don’t-think can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Don’t-think Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Don’t-think Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Don’t-think",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Don’t-think to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Don’t-think plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Don’t-think will verify the Computer Use tools against the exact session when your first session starts.",
